# pylint: disable=missing-function-docstring, invalid-name, missing-module-docstring
# !/usr/bin/env python3
# -*- coding: utf-8 -*-
...
def main():
    while True:
        ...
        print("12) Search a country name: ")
        print("13) total CO2/Country: ")
        print("14) CO2/Capita: ")
        print("15) CO2/Area: ")
        ...
        if choice == "1":
            ...
            emission_functions.func12()
        elif choice == "13":
            emission_functions.func13()
        elif choice == "14":
            emission_functions.func14()
        elif choice == "15":
            emission_functions.func15()
        elif choice == "A1":
            marvin.funcA1()
        elif choice == "A4":
            marvin.funcA4()
